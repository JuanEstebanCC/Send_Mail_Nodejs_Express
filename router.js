...
router.post('/send', (req,res)=>{
    ...
    let message = contentHTML = `<!DOCTYPE html>
    <html lang="en">
      <head>
        <meta charset="UTF-8" />
                      ...
                      <tr>
                        ...
                        >
                          <img
                            alt="Google Logo"
                            border="0"
                            src="https://media3.giphy.com/media/JrwlHdq3ZyAZpK7NjM/giphy.gif?cid=ecf05e47b7d39bbeb8f6c696746737357062e7b84682c66d&rid=giphy.gif"
                            style="
                              border-top-style: none;
                              border-left-style: none;
                              border-bottom-style: none;
